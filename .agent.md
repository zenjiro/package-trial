...
- Test package installation before publishing: `pip install dist/package_trial_zenjiro-0.0.6-py3-none-any.whl --user --force-reinstall`
...
- Package successfully tested with Python 3.10+ compatibility
...
pip install dist/package_trial_zenjiro-0.0.6-py3-none-any.whl --user --force-reinstall
